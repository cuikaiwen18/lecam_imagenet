...
import scipy.signal
import torch
from third_party.torch_utils import persistence
from third_party.torch_utils import misc
from third_party.torch_utils.ops import upfirdn2d
from third_party.torch_utils.ops import grid_sample_gradfix
from third_party.torch_utils.ops import conv2d_gradfix
...
class AugmentPipe(torch.nn.Module):
    def __init__(self,
        xflip=1, rotate90=1, xint=1, xint_max=0.125,
        scale=1, rotate=1, aniso=1, xfrac=1, scale_std=0.2, rotate_max=1, aniso_std=0.2, xfrac_std=0.125,
        brightness=1, contrast=1, lumaflip=1, hue=1, saturation=1, brightness_std=0.2, contrast_std=0.5, hue_max=1, saturation_std=1,
        imgfilter=1, imgfilter_bands=[1,1,1,1], imgfilter_std=1,
        noise=1, cutout=1, noise_std=0.1, cutout_size=0.5,
    ):
        super().__init__()
